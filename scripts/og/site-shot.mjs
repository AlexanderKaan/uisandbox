...
await og.addStyleTag({ content: '.app__topbar{display:none!important}.intake{padding-top:34px!important}.hero__kicker{margin-top:0!important}' })
...
await d.addStyleTag({ content: '.app__topbar{display:none!important}.intake{padding-top:34px!important}.hero__kicker{margin-top:0!important}' })
