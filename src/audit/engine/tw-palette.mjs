/* GENERATED by scripts/gen-tw-palette.mjs — do not edit.
 * Tailwind's default colour palettes, read from the files Tailwind publishes:
 *   v3 ← tailwindcss@3.4.17 lib/public/colors.js (hex)
 *   v4 ← tailwindcss@4.3.3 theme.css (oklch, kept as shipped)
...
export const TW_DEFAULT_VERSIONS = { v3: '3.4.17', v4: '4.3.3' }
